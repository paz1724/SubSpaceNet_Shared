""" This script is a help source for bgu to translate text files to arrays and for doing the
other direction too.
"""
...
if __name__ == '__main__':
    test_interpolation(8000, r'T:\Projects\SSP\magneton\pass to gbu\arrays.txt')
